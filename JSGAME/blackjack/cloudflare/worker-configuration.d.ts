/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3fa38deb9372191989493a422e88f2c7)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	blackjack_users: D1Database;
	ALLOWED_ORIGINS: "https://shuaigaodada.github.io,http://localhost:5173,http://127.0.0.1:5173";
	AUTH_SERVICE_URL: "https://laogao-gpt-proxy-295046-9-1403518541.sh.run.tcloudbase.com";
	BLACKJACK_TABLE: DurableObjectNamespace<import("./src/index").BlackjackTable>;
	LGGPT_API: Fetcher /* laogao-gpt-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BlackjackTable";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "AUTH_SERVICE_URL">> {}
}
